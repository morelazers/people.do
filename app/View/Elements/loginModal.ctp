      ...
      <div class="modal-body">
          ...
          <div class="modal-login-form pull-left">
              <?php
                  ...
                  echo $this->Form->submit('Login', array('type' => 'submit', 'class' => 'login-button btn-modal btn btn-default', 'id' => 'ModalLoginSubmit'));
                  echo $this->Form->end();
              ?>
              <br />
          ...
          <div class="modal-register-form pull-right">
              ...
              <?php
                  echo $this->Form->submit('Register', array('type' => 'submit', 'class' => 'register-button btn-modal btn btn-default', 'id' => 'RegisterButton'));
                  echo $this->Form->end();
              ?>
